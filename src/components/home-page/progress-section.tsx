...
const EnergyCounter = ({ energy }: EnergyCounterProps) => (
  <div className={cn("inline-flex items-center justify-between bg-[#1d1f1d] rounded-2xl h-[40px] pl-2 pr-3", energy === 0 && 'pl-0 pr-0 px-2')}>
    {energy === 0 ?
    ...
    : 
      <>
        ...
        <span className="text-base text-[#A45FFF] [text-shadow:0px_0px_12px_#9C1FFD]">{energy ?? '...'}</span>
      </>
    }
  </div>
)
