...
//       <FlickeringGrid
//         className="absolute top-[40px] z-0 [mask-image:radial-gradient(145px_circle_at_center,white,transparent)]"
//         squareSize={2}
//         gridGap={12}
//         color="#b7ff01"
//         maxOpacity={0.5}
...
//         }}
//       >
//         <div className="pointer-events-none absolute top-1/2 -translate-y-1/2 h-5 w-1/2 bg-[radial-gradient(ellipse_150px_4px_at_left,_rgba(182,255,0,0.3)_0%,_transparent_100%)]" />
//         <CarouselContent className="h-[48px] ml-0 w-full">
...
// }) {
//   return (
//     <CarouselItem className="basis-1/4 h-full pl-0">
//       <Link to="/gate" className="flex items-center justify-center h-full">
//         <div
//           className={cn(
...
//         {lvl > 1 && (
//           <Marquee
//             className="absolute top-[5px] -translate-y-1/2"
//             autoFill
//             direction="right"
//           >
//             <ArrowIcon />
