...
export const LevelsList = () => {
  return (
    <Carousel
      className="relative pl-2 -mt-10 -mb-5"
      opts={{
        slidesToScroll: 4,
        align: 'center',
      }}
    >
      <CarouselContent className="relative pt-6">
        <MarqueeArrows />
        {levels.map((level) => (
...
export const CarouselLvlItem = ({
  ...
  return (
    <CarouselItem className="relative basis-1/4 h-[106px] flex items-center justify-center">
      <FlickeringGrid
        className="absolute inset-0 z-[-1] mask-[radial-gradient(ellipse_60px_50px_at_center,black,transparent)]"
        squareSize={2}
        gridGap={12}
        color="#b7ff01"
        maxOpacity={0.5}
...
const MarqueeArrows = () => {
  return (
    <div className="absolute top-[72px] w-full z-[-1]">
