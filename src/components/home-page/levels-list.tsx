...
export const LevelsList = () => {
  return (
    <div className='relative -mt-[10px] w-full'>
      <div className='pointer-events-none absolute inset-y-0 top-[20px] -right-10 z-20 h-[70px] w-full bg-gradient-to-l from-[#121312] via-transparent via-40% to-transparent to-95%' />
      ...
      <Link to='/gate'>
        <Carousel className='relative z-10 h-[90px]' opts={{ slidesToScroll: 4, align: 'center' }}>
          <CarouselContent>
            <MarqueeArrows />
            {levels.map((level) => (
