...
export const ButtonFarmingActive = ({
  elapsedHours,
  elapsedMinutes,
  elapsedSeconds,
  remainingHours,
  ...
  return (
    <Button className="rounded-[16px] text-lg bg-[#232a16] w-full p-4 h-[56px]">
      <div className="absolute">
        <div className="flex gap-2 items-center mb-1">
          <span className="text-[#B6FF00] text-[18px] font-[400] font-pixel leading-[24px] uppercase">
            farming
          </span>
          <div>
            <svg
          ...
          <div className="text-[#B6FF00] font-[400] font-pixel text-[18px] leading-[24px]">
            <span>{elapsedHours}</span>:<span>{elapsedMinutes}</span>:
            <span>{elapsedSeconds}</span>
          </div>
        </div>
        <div className="text-[#B6FF00]/60 mr-3 font-inter text-[10px] leading-[10px] tracking-[0.3px]">
