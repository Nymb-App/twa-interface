    ...
    <div className={cn(
      ...
      <div className={cn(
        ...
        <div>
          ...
          <p className="mt-1 font-light text-xs text-white/50 text-center leading-3">{description}</p>
          {subdescription && (
            <p className="font-light text-xs text-white/50 text-center">{subdescription}</p>
          )}
        </div>
      </div>
    </div>
