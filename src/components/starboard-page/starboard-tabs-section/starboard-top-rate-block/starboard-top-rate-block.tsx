...
export const StarboardTopRateBlock = ({ users }: { users: Array<number> }) => {
  return (
    <>
      {users.map((_: number, idx: number) => (
        <div
          key={idx}
          className="relative flex gap-4 items-center rounded-[14px] py-[13px] px-[16px] starboard-result-block-bg"
        >
