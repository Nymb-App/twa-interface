...
export const GiftSelector = ({
    ...
    return (
        <div className={cn("font-pixel rounded-[24px] border border-white/10 p-4 backdrop-blur-[16px]", className)}>
            <div className="flex justify-between items-center py-[9px] px-4">
                ...
                >
                    <FiMinus className='text-white absolute top-1/2 left-1/2 -translate-1/2' size={32} />
                </HandlerButton>
                ...
                >
                    <FiPlus className='text-white absolute top-1/2 left-1/2 -translate-1/2' size={32} />
                </HandlerButton>
            </div>
            ...
            >
                {(['days', 'weeks', 'years'] as TUnit[]).map((option) => (
                    <div key={option}>
                        <RadioGroupItem
                            value={option}
                            id={option}
